...
class EmployeeController extends AbstractController
{
    ...
    public function addEmployee(ManagerRegistry $doctrine, Request $request): Response
    {
        ...
        /* Saves the object we pass, first we persist and then we flush */
        $entityManager->persist($employee);
        $entityManager->flush();
        return $this->json('New employee has been added succesfully with id ' . $employee->getId());
    }
    ...
    public function delete(ManagerRegistry $doctrine, int $id): Response
    {
        ...
        $entityManager->flush();
        return $this->json('Deleted an employee successfully with id ' . $id);
    }
}
